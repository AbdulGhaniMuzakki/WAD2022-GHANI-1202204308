...
$sql = "SELECT * FROM showroom_ghani_table WHERE id_mobil = $id";
...
<head>
  ...
  <title>Detail Car | Ghani_1202204308</title>
  ...
  <section id='detail'>
    <div class="container">
      ...
      while ($getDetail = mysqli_fetch_array($result)) {
        echo "
                <h1 class='addh1'>" . $getDetail["nama_mobil"] . "</h1>
                <p class='addp'>Detail Mobil " . $getDetail["nama_mobil"] . "</p>
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Edit-Ghani.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
